...
class AddSlotController extends GetxController implements GetxService {
  ...
  Future<void> openTimePicker() async {
    ...
    openTime = Jiffy.parseFromMap({Unit.year: 2020, Unit.month: 10, Unit.day: 19, Unit.hour: pickedTime!.hour, Unit.minute: pickedTime.minute}).format(pattern: "hh:mm a").toString();
  ...
  Future<void> closeTimePicker() async {
    ...
    closeTime = Jiffy.parseFromMap({Unit.year: 2020, Unit.month: 10, Unit.day: 19, Unit.hour: pickedTime!.hour, Unit.minute: pickedTime.minute}).format(pattern: "hh:mm a").toString();
    update();
  }
