...
import 'package:freelancer/app/backend/model/analytics_model.dart';
import 'package:freelancer/app/backend/model/months_analytics_model.dart';
import 'package:freelancer/app/backend/model/yearly_analytics_model.dart';
...
class AnalyzeController extends GetxController implements GetxService {
  ...
  List<String> monthsListNames = ['January'.tr, 'February'.tr, 'March'.tr, 'April'.tr, 'May'.tr, 'June'.tr, 'July'.tr, 'August'.tr, 'September'.tr, 'October'.tr, 'November'.tr, 'December'.tr];
  ...
  List<String> generateRowOfMonths(from, to) {
    ...
    for (int i = from; i <= to; i++) {
      ...
      months.add('${Jiffy.parse(dateTime.toString()).MMM} $pickerYear');
    }
    return months;
  }
