                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                smallBoldText(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.appointmentDetail.total.toString()}' : '${value.appointmentDetail.total.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                            const SizedBox(height: 6),
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  value.currencySide == 'left' ? '-${value.currencySymbol}${value.appointmentDetail.discount.toString()}' : '-${value.appointmentDetail.discount.toString()}${value.currencySymbol}',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                smallBoldText(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.appointmentDetail.distanceCost.toString()}' : '${value.appointmentDetail.distanceCost.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                            const SizedBox(height: 6),
                            Row(
                              ...
                              children: [
                                ...
                                smallBoldText(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.appointmentDetail.serviceTax.toString()}' : '${value.appointmentDetail.serviceTax.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                heading4(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.appointmentDetail.grandTotal.toString()}' : '${value.appointmentDetail.grandTotal.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                          ],
