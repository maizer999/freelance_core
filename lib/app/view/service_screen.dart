                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  Text(
                                                    value.currencySide == 'left' ? '${value.currencySymbol}${value.servicesList[i].price.toString()}' : '${value.servicesList[i].price.toString()}${value.currencySymbol}',
                                                    style: const TextStyle(decoration: TextDecoration.lineThrough, color: ThemeProvider.greyColor, fontSize: 12),
                                                  ),
                                                  const SizedBox(width: 16),
                                                  Text(
                                                    value.currencySide == 'left' ? '${value.currencySymbol}${value.servicesList[i].off.toString()}' : '${value.servicesList[i].off.toString()}${value.currencySymbol}',
