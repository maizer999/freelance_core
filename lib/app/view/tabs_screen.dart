        ...
        child: Scaffold(
          ...
          bottomNavigationBar: (TabBar(
            ...
            tabs: [
              ...
              Tab(
                icon: Icon(value.currentIndex == 1 ? Icons.shopping_bag_sharp : Icons.shopping_bag_outlined, color: value.currentIndex == 1 ? ThemeProvider.appColor : const Color.fromARGB(255, 185, 196, 207)),
                text: 'Orders'.tr,
              ),
              Tab(
                icon: Icon(value.currentIndex == 2 ? Icons.currency_exchange_sharp : Icons.currency_exchange_outlined, color: value.currentIndex == 2 ? ThemeProvider.appColor : const Color.fromARGB(255, 185, 196, 207)),
                text: 'Earnings'.tr,
              ),
              Tab(
