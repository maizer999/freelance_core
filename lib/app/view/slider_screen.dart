                                            ...
                                            return GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  color: (Theme.of(context).brightness == Brightness.light ? ThemeProvider.whiteColor : ThemeProvider.secondaryAppColor).withValues(alpha: value.current == entry.key ? 1 : 0.6),
                                                ),
                                              ),
                                            );
                                          },
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(
                                              ...
                                              style: const TextStyle(fontFamily: 'bold', fontSize: 24, height: 1.3, color: ThemeProvider.whiteColor),
                                            ),
                                          ),
                                          Container(
                                            ...
                                            child: Text(
                                              e.text.tr,
                                              textAlign: TextAlign.center,
                                              style: const TextStyle(fontFamily: 'medium', fontSize: 14, height: 1.3, color: ThemeProvider.whiteColor),
                                            ),
                                          ),
                                          const SizedBox(height: 20),
                                          MyElevatedButton(
                                            onPressed: () => Get.toNamed(AppRouter.getWelcomeRoute()),
