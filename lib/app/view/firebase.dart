...
import 'package:freelancer/app/controller/firebase_controller.dart';
    ...
    return GetBuilder<FirebaseController>(
      builder: (value) {
        return Scaffold(
          ...
          body: Stack(
            children: <Widget>[WebViewWidget(controller: _controller), isLoading ? const Center(child: CircularProgressIndicator(color: ThemeProvider.whiteColor)) : const Stack()],
          ),
        );
      },
    );
