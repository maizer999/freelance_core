                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: value.isLogin.value == true ? const CircularProgressIndicator(color: ThemeProvider.whiteColor) : Text('Send OTP'.tr, style: const TextStyle(fontFamily: 'regular', fontSize: 16)),
                        ),
                      ],
                    )
                  : Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: value.isLogin.value == true ? const CircularProgressIndicator(color: ThemeProvider.whiteColor) : Text('Update Password'.tr, style: const TextStyle(fontFamily: 'regular', fontSize: 16)),
                        ),
                      ],
                    ),
            ),
