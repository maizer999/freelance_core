...
import 'package:freelancer/app/controller/contactus_controller.dart';
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                value.isLogin.value == true ? const CircularProgressIndicator(color: Colors.white) : Text('Submit'.tr, style: const TextStyle(color: Colors.white, fontSize: 17, fontFamily: 'bold')),
                              ],
                            ),
                          ),
                        ),
