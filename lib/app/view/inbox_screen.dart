                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [heading4('${value.chatList[index].receiverName} ${value.chatList[index].receiverLastName}'), smallText(value.chatList[index].updatedAt.toString())],
                                                ),
                                              ],
                                            ),
                                          ),
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                  children: [heading4('${value.chatList[index].senderFirstName} ${value.chatList[index].senderLastName}'), smallText(value.chatList[index].updatedAt.toString())],
                                                ),
                                              ],
                                            ),
                                          ),
