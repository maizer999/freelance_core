                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  value.currencySide == 'left' ? '-${value.currencySymbol}${value.orderDetail.discount.toString()}' : '-${value.orderDetail.discount.toString()}${value.currencySymbol}',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                smallBoldText(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.orderDetail.deliveryCharge.toString()}' : '${value.orderDetail.deliveryCharge.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                            const SizedBox(height: 6),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                heading4(
                                  value.currencySide == 'left' ? '${value.currencySymbol}${value.orderDetail.grandTotal.toString()}' : '${value.orderDetail.grandTotal.toString()}${value.currencySymbol}',
                                ),
                              ],
                            ),
                          ],
