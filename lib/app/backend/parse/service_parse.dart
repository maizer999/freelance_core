...
class ServiceParser {
  ...
  ServiceParser({required this.sharedPreferencesManager, required this.apiService});
  ...
  Future<Response> deleteService(var body) async {
    var response = await apiService.postPrivate(AppConstants.deleteService, body, sharedPreferencesManager.getString('token') ?? '');
    return response;
  }
