...
class CityParser {
  ...
  CityParser({required this.sharedPreferencesManager, required this.apiService});

  Future<Response> getAllCity() async {
    var response = await apiService.getPrivate(AppConstants.getAllCity, sharedPreferencesManager.getString('token') ?? '');
    return response;
  }
}
