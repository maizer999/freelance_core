...
class ProductOrderModel {
  ...
  ProductOrderModel.fromJson(Map<String, dynamic> json) {
    ...
    dateTime = Jiffy.parse(json['date_time']).yMMMMEEEEdjm;
...
class UserInfo {
  ...
  UserInfo({this.id, this.firstName, this.lastName, this.email, this.countryCode, this.mobile, this.cover, this.gender, this.type, this.fcmToken, this.stripeKey, this.extraField, this.status, this.createdAt, this.updatedAt});
